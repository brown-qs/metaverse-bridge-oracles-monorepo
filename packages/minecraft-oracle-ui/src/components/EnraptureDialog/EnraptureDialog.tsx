...
export const EnraptureDialog = () => {
  ...
  /*
    ...
    if (!enraptureParamsLoaded && !!enraptureDialogData) {
    ...
    const assetAddress = enraptureDialogData?.assetAddress;
    const assetId = String(enraptureDialogData?.numericId);
    const assetType = enraptureDialogData?.assetType;
