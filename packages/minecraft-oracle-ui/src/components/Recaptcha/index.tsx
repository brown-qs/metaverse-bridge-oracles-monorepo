...
export interface ReCAPTCHAProps {
  ...
  type?: "image" | "audio";
  tabindex?: number;
  onExpired?(...args: unknown[]): unknown;
  onErrored?(...args: unknown[]): unknown;
...
export class ReCAPTCHA extends React.Component<ReCAPTCHAProps, Readonly<{}>> {
  _widgetId: undefined | number;
  _executeRequested!: boolean;
  executionResolve: ((value: unknown) => void) | undefined;
  executionReject: ((reason?: any) => void) | undefined;
  captcha: any;
  ...
  handleChange(token: string | null) {
