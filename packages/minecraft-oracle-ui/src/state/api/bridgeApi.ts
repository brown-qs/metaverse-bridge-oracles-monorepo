...
export const bridgeApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        faucetStatus: builder.query<FaucetResponseDto, void>({
            query: () => (`/oracle/faucet`),
        }),
        faucet: builder.mutation<FaucetResponseDto, FaucetRequestDto>({
            query: (body) => ({
                url: `/oracle/faucet`,
                method: "PUT",
                body
