import { api } from './baseGeneratedSquidExosamaApi';
...
export type GetExosamaMetadataQueryVariables = Exact<{
  erc721Where?: InputMaybe<Erc721TokenWhereInput>;
}>;


export type GetExosamaMetadataQuery = { __typename?: 'Query', erc721Tokens: Array<{ __typename?: 'ERC721Token', numericId: any, metadata?: { __typename?: 'Metadata', type?: string | null, name?: string | null, layers?: Array<string> | null, image?: string | null, description?: string | null, composite?: boolean | null, attributes?: Array<{ __typename?: 'Attribute', value: string, traitType: string, displayType?: string | null }> | null } | null, contract: { __typename?: 'ERC721Contract', address?: string | null } }> };

export type GetExosamaOnChainTokensQueryVariables = Exact<{
  owner: Scalars['String'];
}>;


export type GetExosamaOnChainTokensQuery = { __typename?: 'Query', erc721Tokens: Array<{ __typename?: 'ERC721Token', numericId: any, id: string, metadata?: { __typename?: 'Metadata', image?: string | null, layers?: Array<string> | null, name?: string | null, type?: string | null, description?: string | null, composite?: boolean | null, attributes?: Array<{ __typename?: 'Attribute', displayType?: string | null, traitType: string, value: string }> | null } | null, contract: { __typename?: 'ERC721Contract', address?: string | null } }> };
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    getExosamaMetadata: build.query<GetExosamaMetadataQuery, GetExosamaMetadataQueryVariables | void>({
      query: (variables) => ({ document: GetExosamaMetadataDocument, variables })
    }),
    getExosamaOnChainTokens: build.query<GetExosamaOnChainTokensQuery, GetExosamaOnChainTokensQueryVariables>({
      query: (variables) => ({ document: GetExosamaOnChainTokensDocument, variables })
    }),
  }),
});

export { injectedRtkApi as api };
export const { useGetExosamaMetadataQuery, useLazyGetExosamaMetadataQuery, useGetExosamaOnChainTokensQuery, useLazyGetExosamaOnChainTokensQuery } = injectedRtkApi;
