        ...
        <Container maxWidth={false} style={{ paddingLeft: 0, paddingRight: 0 }} sx={{ paddingTop: '4px', paddingBottom: '4px' }}>
          <Stack direction='row' alignItems="center" justifyContent="space-between">
            ...
            {!showRegularMenu ? (
              //big menu
              <>
                <Stack direction="row" onClick={() => setIsDrawerOpened(false)} sx={{ flexGrow: 1, marginLeft: 2 }} >
                  <Stack direction="row" className={menuNavItemRegular}><NavMenuItem href={'/bridge'} label={`Bridge`} /></Stack>
                  <Stack direction="row" className={menuNavItemRegular}><NavMenuItem href={'/moonsama/customizer'} label={`Customizer`} /></Stack>
                  <Stack direction="row" className={menuNavItemRegular}><NavMenuItem href={'https://marketplace.moonsama.com'} label={`Marketplace`} external={true} /></Stack>
                  <Stack direction="row" className={menuNavItemRegular}><NavMenuItem href={'https://wiki.moonsama.com'} label={`Docs`} external={true} /></Stack>
                </Stack>
                <Stack direction="row">
                  <Stack direction="row" className={menuNavItemRegular}><CarnageStatus /></Stack>
                  <Stack direction="row" className={menuNavItemRegular}><ConnectedNetwork /></Stack>
                  <Stack direction="row" className={menuNavItemRegular}><WalletAccount /></Stack>
                  <Stack direction="row" className={menuNavItemRegular}><ServerAccount /></Stack>
                </Stack>
              </>
              ...
              //small menu
              <Stack direction='row' alignItems="center" justifyContent="space-between">
                <Box sx={{ paddingRight: 1 }} className={menuNavItemRegular}><WalletAccount /></Box>
