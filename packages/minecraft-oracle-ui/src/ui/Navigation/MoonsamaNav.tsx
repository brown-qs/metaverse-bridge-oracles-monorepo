  ...
  return (
    <AppBar sx={{ backgroundColor: '#1B1B3A', boxShadow: '0px 20px 25px -5px rgba(0, 0, 0, 0.1), 0px 10px 10px -5px rgba(0, 0, 0, 0.04)' }} position="static">
      <Toolbar sx={{ position: 'relative' }}>
        <Container maxWidth={false} sx={{ paddingTop: '4px', paddingBottom: '4px', paddingLeft: 0, paddingRight: 0 }}>
            ...
            <Stack direction='row' justifyContent='flex-end'>
              {!showRegularMenu ? (
                <Stack direction={'row'} onClick={() => setIsDrawerOpened(false)}>
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><Marketplace /></div>
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><Docs /></div>
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><CarnageStatus /></div>
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><ConnectedNetwork /></div>
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><WalletAccount /></div>
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><ServerAccount /></div>
                </Stack>
              ) : (
                <Stack direction='row' alignItems="center" justifyContent="space-between">
                  <div style={{ marginLeft: '4px', marginRight: '4px' }}><WalletAccount /></div>
                  ...
                  <Drawer
                    ...
                    <Box>
                      <div style={{ marginTop: '8px', marginBottom: '8px' }}><Marketplace /></div>
                      <div style={{ marginTop: '8px', marginBottom: '8px' }}><Docs /></div>
                      <div style={{ marginTop: '8px', marginBottom: '8px' }}><CarnageStatus /></div>
                      <div style={{ marginTop: '8px', marginBottom: '8px' }}><ConnectedNetwork /></div>
                      <div style={{ marginTop: '8px', marginBottom: '8px' }}><ServerAccount /></div>
                    </Box>
                  </Drawer>
                </Stack>
              )}
