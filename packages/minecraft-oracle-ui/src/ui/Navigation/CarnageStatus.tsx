...
export default function CarnageStatus() {
  ...
  return (
    <Box sx={{backgroundColor: isGameActive ? 'rgba(14, 235, 168, 0.2)' : 'rgba(251, 122, 111, 0.2)', textTransform: 'uppercase', padding: '12px 24px 12px 16px', fontFamily: 'Orbitron', fontSize: '12px', lineHeight: '16px', letterSpacing: '0.032em', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
      <svg
