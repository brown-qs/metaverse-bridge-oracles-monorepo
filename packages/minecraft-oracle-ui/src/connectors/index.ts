...
export enum WalletSupportedPlatform {
  Mobile = "MOBILE",
  Desktop = "DESKTOP",
  ArmMacDesktop = "ARM_MAC_DESKTOP"
}
export interface WalletInfo {
  ...
  description: string;
  href?: string;
  platforms: WalletSupportedPlatform[]
}
...
export const SUPPORTED_WALLETS: { [key: string]: WalletInfo } = {
  ...
  TALISMAN: {
    ...
    platforms: [WalletSupportedPlatform.Desktop, WalletSupportedPlatform.ArmMacDesktop]
  },
  INJECTED: {
    connector: injected,
    name: 'Injected',
  ...
  NOVA: {
    ...
    platforms: [WalletSupportedPlatform.Mobile, WalletSupportedPlatform.ArmMacDesktop]
  },
  // WALLET_CONNECT: {
